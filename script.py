...
#max sustained winds (mph) of hurricanes
...
#new dictionary of hurricanes with year and key
...
#dictionary of areas to store the number of hurricanes involved
...
#most frequently affected area and the number of hurricanes it is involved in
...
#highest damage inducing hurricane and its total cost
